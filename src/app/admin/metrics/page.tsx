      ...
      <main className="mx-auto max-w-6xl px-4 pb-16 pt-28">
        <div className="flex items-center justify-between">
          ...
          <nav className="flex gap-2">
            ...
            <Link href="/admin/professional" className="rounded-full border border-white/10 px-4 py-2 text-sm font-heading font-semibold text-premium hover:border-[#00DC82]/40">{copy.navProfessional ?? 'Profesional'}</Link>
