...
Declaración de adopción AOS para `anclora-energyscan`.

## Metadatos

- Repository Name: anclora-energyscan
...
`anclora-energyscan` forma parte del ecosistema Anclora como aplicación operativa Next.js.
